 ...
 * <p>
 * This tool supports archiving and anaylzing (sort/grep) of log-files. It takes
 * as input a) Input uri which will serve uris of the logs to be archived. b)
 * Output directory (not mandatory). b) Directory on dfs to archive the logs. c)
 * The sort/grep patterns for analyzing the files and separator for boundaries.
 * Usage: Logalyzer -archive -archiveDir <directory to archive logs> -analysis
 * <directory> -logs <log-list uri> -grep <pattern> -sort <col1, col2>
 * -separator <separator>
 * <p>
 */
...
public class Logalyzer {
    ...
    public static class LogRegexMapper<K extends WritableComparable> extends MapReduceBase implements
     ...
     * 
     * @param logListURI
     *            : The uri which will serve list of log-files to archive.
     * @param archiveDirectory
     *            : The directory to store archived logfiles.
     * @throws IOException
     */
     ...
     *            : Directory to store analysis (output).
     * @param grepPattern
     *            : Pattern to *grep* for.
     * @param sortColumns
     *            : Sort specification for output.
     * @param columnSeparator
     *            : Column separator.
     * @throws IOException
     */
    public void doAnalyze(String inputFilesDirectory, String outputDirectory, String grepPattern, String sortColumns,
    ...
    public static void main(String[] args) {
        ...
        String usage = "Usage: Logalyzer [-archive -logs <urlsFile>] " + "-archiveDir <archiveDirectory> "
                + "-grep <pattern> -sort <column1,column2,...> -separator <separator> " + "-analysis <outputDirectory>";
