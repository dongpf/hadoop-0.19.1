...
public class UpgradeObjectCollection {
    ...
    /**
     * Static collection of upgrade objects sorted by version. Layout versions
     * are negative therefore newer versions will go first.
     */
    ...
    public static SortedSet<Upgradeable> getDistributedUpgrades(int versionFrom, HdfsConstants.NodeType type)
            throws IOException {
        assert FSConstants.LAYOUT_VERSION <= versionFrom : "Incorrect version " + versionFrom + ". Expected to be <= "
