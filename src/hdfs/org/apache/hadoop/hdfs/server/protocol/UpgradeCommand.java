 ...
 * 
 * During the upgrade cluster components send upgrade commands to each other in
 * order to obtain or share information with them. It is supposed that each
 * upgrade defines specific upgrade command by deriving them from this class.
 * The upgrade command contains version of the upgrade, which is verified on the
 * receiving side and current status of the upgrade.
 */
