...
/**
 * A class to implement an array of BlockLocations It provide efficient
 * customized serialization/deserialization methods in stead of using the
 * default array (de)serialization provided by RPC
 */
public class BlocksWithLocations implements Writable {
    ...
    public static class BlockWithLocations implements Writable {
        ...
        public void write(DataOutput out) throws IOException {
            block.write(out);
            WritableUtils.writeVInt(out, datanodeIDs.length); // variable length
                                                              // int
