...
public interface DatanodeProtocol extends VersionedProtocol {
    /**
     * 19: SendHeartbeat returns an array of DatanodeCommand objects in stead of
     * a DatanodeCommand object.
     */
     ...
     * DataNodes, etc.
     */
    public DatanodeCommand[] sendHeartbeat(DatanodeRegistration registration, long capacity, long dfsUsed,
            long remaining, int xmitsInProgress, int xceiverCount) throws IOException;
     ...
     * 
     * The generosity is because the variety of upgrade commands is
     * unpredictable. The reply from the name-node is also received in the form
     * of an upgrade command.
     * 
    ...
    /**
     * same as
     * {@link org.apache.hadoop.hdfs.protocol.ClientProtocol#reportBadBlocks(LocatedBlock[])}
     * }
     */
