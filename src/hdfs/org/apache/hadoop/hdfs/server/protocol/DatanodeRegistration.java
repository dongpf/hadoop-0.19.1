...
/**
 * DatanodeRegistration class conatins all information the Namenode needs to
 * identify and verify a Datanode when it contacts the Namenode. This
 * information is sent by Datanode with each communication request.
 * 
 */
public class DatanodeRegistration extends DatanodeID implements Writable {
   ...
   */
    ...
    public String toString() {
        return getClass().getSimpleName() + "(" + name + ", storageID=" + storageID + ", infoPort=" + infoPort
                + ", ipcPort=" + ipcPort + ")";
    }
