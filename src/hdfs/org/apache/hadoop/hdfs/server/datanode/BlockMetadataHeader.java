...
/**
 * BlockMetadataHeader manages metadata for data blocks on Datanodes. This is
 * not related to the Block related functionality in Namenode. The biggest part
 * of data block metadata is CRC for the block.
 */
class BlockMetadataHeader {
    ...
    /**
     * Header includes everything except the checksum(s) themselves. Version is
     * two bytes. Following it is the DataChecksum that occupies 5 bytes.
     */
