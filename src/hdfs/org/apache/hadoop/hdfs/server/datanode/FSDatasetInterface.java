...
/**
 * This is an interface for the underlying storage that stores blocks for a data
 * node. Examples are the FSDataset (which stores blocks on dirs) and
...
public interface FSDatasetInterface extends FSDatasetMBean {
    ...
    /**
     * This class provides the input stream and length of the metadata of a
     * block
     * 
     */
    ...
    /**
     * 
     * This class contains the output streams for the data and checksum of a
     * block
     * 
     */
    ...
    /**
     * This class contains the input streams for the data and checksum of a
     * block
     */
     ...
     * @return a BlockWriteStreams object to allow writing the block data and
     *         CRC
     * @throws IOException
     */
    ...
    /**
     * Sets the file pointer of the data stream and checksum stream to the
     * specified values.
     * 
     * @param b
     * @param stream
     *            The stream for the data file and checksum file
     * @param dataOffset
     ...
     * @throws IOException
     */
    public void setChannelPosition(Block b, BlockWriteStreams stream, long dataOffset, long ckOffset)
            throws IOException;

    /**
     * Validate that the contents in the Block matches the file on disk. Returns
