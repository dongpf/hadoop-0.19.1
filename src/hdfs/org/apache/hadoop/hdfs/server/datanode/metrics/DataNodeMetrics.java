...
/**
 * 
 * This class is for maintaining the various DataNode statistics and publishing
 * them through the metrics interfaces. This also registers the JMX MBean for
 * RPC.
 * <p>
...
public class DataNodeMetrics implements Updater {
    ...
    public MetricsLongValue bytesWritten = new MetricsLongValue("bytes_written");
    public MetricsLongValue bytesRead = new MetricsLongValue("bytes_read");
    ...
    public MetricsTimeVaryingRate blockChecksumOp = new MetricsTimeVaryingRate("blockChecksumOp");
