...
public class FileDataServlet extends DfsServlet {
    ...
    private URI createUri(FileStatus i, UnixUserGroupInformation ugi, ClientProtocol nnproxy, String scheme)
        ...
        return new URI(scheme, null, hostname, "https".equals(scheme) ? (Integer) getServletContext().getAttribute(
                "datanode.https.port") : host.getInfoPort(), "/streamFile", "filename=" + i.getPath() + "&ugi=" + ugi,
                null);
    }
    ...
    /**
     * Select a datanode to service this request. Currently, this looks at no
     * more than the first five blocks of a file, selecting a datanode randomly
