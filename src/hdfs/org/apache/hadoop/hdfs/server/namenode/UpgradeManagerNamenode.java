 ...
 * 
 * Distributed upgrades for a name-node starts when the safe mode conditions are
 * met and the name-node is about to exit it. At this point the name-node enters
 * manual safe mode which will remain on until the upgrade is completed. After
 * that the name-nodes processes upgrade commands from data-nodes and updates
 * its status.
 */
