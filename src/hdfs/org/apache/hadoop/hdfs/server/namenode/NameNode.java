 ...
 * interface to the outside world, plus some configuration management.
 * 
...
public class NameNode implements ClientProtocol, DatanodeProtocol, NamenodeProtocol, FSConstants {
     ...
     * <ul>
     * <li>
     * {@link org.apache.hadoop.hdfs.server.common.HdfsConstants.StartupOption#REGULAR
     * REGULAR} - normal startup</li>
     * <li>
     * {@link org.apache.hadoop.hdfs.server.common.HdfsConstants.StartupOption#FORMAT
     * FORMAT} - format name node</li>
     * <li>
     * {@link org.apache.hadoop.hdfs.server.common.HdfsConstants.StartupOption#UPGRADE
     * UPGRADE} - start the cluster upgrade and create a snapshot of the current
     * file system state</li>
     * <li>
     * {@link org.apache.hadoop.hdfs.server.common.HdfsConstants.StartupOption#ROLLBACK
     * ROLLBACK} - roll the cluster back to the previous state</li>
     * </ul>
    ...
    public void create(String src, FsPermission masked, String clientName, boolean overwrite, short replication,
        ...
        namesystem.startFile(src,
                new PermissionStatus(UserGroupInformation.getCurrentUGI().getUserName(), null, masked), clientName,
                clientMachine, overwrite, replication, blockSize);
   ...
   */
    public boolean rename(String src, String dst) throws IOException {
        ...
        if (!checkPathLength(dst)) {
            throw new IOException("rename: Pathname too long.  Limit " + MAX_PATH_LENGTH + " characters, "
                    + MAX_PATH_DEPTH + " levels.");
        }
   ...
   */
    ...
    public boolean mkdirs(String src, FsPermission masked) throws IOException {
        ...
        return namesystem.mkdirs(src, new PermissionStatus(UserGroupInformation.getCurrentUGI().getUserName(), null,
                masked));
    }
   ...
   */
    ...
    public HdfsLocatedFileStatus[] getHdfsLocatedListing(String src) throws IOException {
        throw new IOException("not supported by this version");
    }
   ...
   */
    ...
    private static StartupOption parseArguments(String args[], Configuration conf) {
