...
public abstract class INode implements Comparable<byte[]> {
    ...
    private static enum PermissionStatusFormat {
        MODE(0, 16), GROUP(MODE.OFFSET + MODE.LENGTH, 25), USER(GROUP.OFFSET + GROUP.LENGTH, 23);
    ...
    /**
     * Collect all the blocks in all children of this INode. Count and return
    ...
    /**
     * Adds total nubmer of names and total disk space taken under this tree to
