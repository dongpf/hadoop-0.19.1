...
/**
 * 
 * This class is for maintaining the various NameNode statistics and publishing
...
public class NameNodeMetrics implements Updater {
    ...
    public NameNodeMetrics(Configuration conf, NameNode nameNode) {
        ...
        log.info("Initializing NameNodeMeterics using context object:" + metricsContext.getClass().getName());
    }
