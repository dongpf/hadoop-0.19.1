...
class TransferFsImage implements FSConstants {
     ...
     *            parameters
     * @param request
     *            the object from which this servelet reads the url contents
     * @param response
    ...
    /**
     * A server-side method to respond to a getfile http request Copies the
     * contents of the local file into the output stream.
     */
    ...
    /**
     * Client-side Method to fetch file from a server Copies the response from
     * the URL to a list of local files.
     */
