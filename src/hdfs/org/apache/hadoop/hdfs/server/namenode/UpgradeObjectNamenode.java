...
/**
 * Base class for name-node upgrade objects. Data-node upgrades are run in
 * separate threads.
 */
public abstract class UpgradeObjectNamenode extends UpgradeObject {

    /**
     * Process an upgrade command. RPC has only one very generic command for all
     * upgrade related inter component communications. The actual command
     * recognition and execution should be handled here. The reply is sent back
     * also as an UpgradeCommand.
     * 
     * @param command
