 ...
 * <ul>
 * <li>none (
 * {@link org.apache.hadoop.hdfs.server.namenode.NamenodeFsck#FIXING_NONE})</li>
 * <li>move corrupted files to /lost+found directory on DFS (
 * {@link org.apache.hadoop.hdfs.server.namenode.NamenodeFsck#FIXING_MOVE}).
 * Remaining data blocks are saved as a block chains, representing longest
 * consecutive series of valid blocks.</li>
 * <li>delete corrupted files (
 * {@link org.apache.hadoop.hdfs.server.namenode.NamenodeFsck#FIXING_DELETE})</li>
 * </ul>
 * </li>
 ...
 * factors of each file. The tool also provides and option to filter open files
 * during the scan.
 * 
 */
public class DFSck extends Configured implements Tool {
    ...
    private String getInfoServer() throws IOException {
        return NetUtils.getServerAddress(getConf(), "dfs.info.bindAddress", "dfs.info.port", "dfs.http.address");
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        String line = null;
        int errCode = 0;
        // errCode returned indicating the status of Filesystem
        // (HEALTHY/CORRUPT)
        // depends on the format of the string. Changing the script might break
        // fsck related testcases. For now, we scan for "is CORRUPT" as it
        // unique.
        try {
