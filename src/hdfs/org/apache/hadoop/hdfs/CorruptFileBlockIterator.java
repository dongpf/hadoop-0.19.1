...
/**
 * Provides an iterator interface for listCorruptFileBlocks. This class is used
 * by DistributedFileSystem and Hdfs.
 */
public class CorruptFileBlockIterator implements RemoteIterator<Path> {
    ...
    /**
     * @return the number of calls made to the DFSClient. This is for debugging
