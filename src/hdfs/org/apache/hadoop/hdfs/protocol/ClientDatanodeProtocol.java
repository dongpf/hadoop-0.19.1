...
public interface ClientDatanodeProtocol extends VersionedProtocol {
     ...
     * @param targets
     *            the list of possible locations of specified block
     * @return the new blockid if recovery successful and the generation stamp
     *         got updated as part of the recovery, else returns null if the
     *         block id not have any data and the block was deleted.
     * @throws IOException
     */
