...
/**
 * This class provides an interface for accessing list of blocks that has been
 * implemented as long[]. This class is usefull for block report. Rather than
 * send block reports as a Block[] we can send it as a long[].
 * 
 */
public class BlockListAsLongs {
    /**
     * A block as 3 longs block-id and block length and generation stamp
     */
