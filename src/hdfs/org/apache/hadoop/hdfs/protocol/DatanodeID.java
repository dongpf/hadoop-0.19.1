...
/**
 * DatanodeID is composed of the data node name (hostname:portNumber) and the
 * data storage ID, which it currently represents.
 * 
 */
public class DatanodeID implements WritableComparable<DatanodeID> {
    ...
    /**
     * Update fields when a new registration request comes in. Note that this
     * does not update storageID.
     */
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        // the infoPort read could be negative, if the port is a large number
        // (more
