...
public class JobConf extends Configuration {
    ...
    public InputFormat getInputFormat() {
        return ReflectionUtils.newInstance(
                getClass("mapred.input.format.class", TextInputFormat.class, InputFormat.class), this);
    }
    ...
    public OutputFormat getOutputFormat() {
        return ReflectionUtils.newInstance(
                getClass("mapred.output.format.class", TextOutputFormat.class, OutputFormat.class), this);
    }
    ...
    public OutputCommitter getOutputCommitter() {
        return (OutputCommitter) ReflectionUtils.newInstance(
                getClass("mapred.output.committer.class", FileOutputCommitter.class, OutputCommitter.class), this);
    }
     ...
     * helps to cut down the amount of data transferred from the {@link Mapper}
     * to the {@link Reducer}, leading to better performance.
     * </p>
     * 
     * <p>
     * Typically the combiner is same as the the <code>Reducer</code> for the
   ...
   * <a href="{@docRoot} blocksize of the
     ...
     * /../hadoop-default.html#mapred.min.split.size">
   ...
   * <a href="{@docRoot} multiplied by (&lt;<i>no. of nodes</i>&gt; * <a
     * href="{@docRoot}
     * /../hadoop-default.html#mapred.tasktracker.reduce.tasks.maximum">
     ...
     * modifying the hadoop-site.xml file before starting the cluster.
     * 
    ...
    public String getProfileParams() {
        return get("mapred.task.profile.params", "-agentlib:hprof=cpu=samples,heap=sites,force=n,thread=y,"
                + "verbose=n,file=%s");
    }
     ...
     * @see JobStatus
     * @see <a
     *      href="{@docRoot}/org/apache/hadoop/mapred/JobClient.html#JobCompletionAndChaining">Job
     *      Completion and Chaining</a>
     */
     ...
     * 
     * A task of this job will be scheduled on a tasktracker, only if the amount
     * of free memory on the tasktracker is greater than or equal to this value.
     * 
     * If set to {@link #DISABLED_VIRTUAL_MEMORY_LIMIT}, tasks are assured a
     * memory limit set to mapred.task.default.maxmemory. If the value of
     ...
     * 
     * @param vmem
     *            Maximum amount of memory in kilobytes any task of this job can
     *            use.
