 ...
 * 
 * <p>
 * Custom implementations of <code>MapRunnable</code> can exert greater control
 * on map processing e.g. multi-threaded, asynchronous mappers etc.
 * </p>
 * 
 * @see Mapper
 */
public interface MapRunnable<K1, V1, K2, V2> extends JobConfigurable {
     ...
     * 
     * @param input
     *            the {@link RecordReader} to read the input records.
     * @param output
     *            the {@link OutputCollector} to collect the outputrecords.
     * @param reporter
     *            {@link Reporter} to report progress, status-updates etc.
     * @throws IOException
     */
