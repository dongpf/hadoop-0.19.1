...
/**
 * Used by a {@link JobTracker} to schedule {@link Task}s on {@link TaskTracker}
 * s.
 * <p>
 * {@link TaskScheduler}s typically use one or more
 * {@link JobInProgressListener}s to receive notifications about jobs.
 * <p>
 * It is the responsibility of the {@link TaskScheduler} to initialize tasks for
 * a job, by calling {@link JobInProgress#initTasks()} between the job being
 * added (when {@link JobInProgressListener#jobAdded(JobInProgress)} is called)
