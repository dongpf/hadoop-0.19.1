 ...
 * <li>
 * The number of currently running map & reduce tasks.</li>
 * <li>
 * State of the <code>JobTracker</code>.</li>
 * </ol>
 * </p>
 * 
 * <p>
...
public class ClusterStatus implements Writable {
     ...
     * @param maps
     *            no. of currently running map-tasks in the cluster
     * @param reduces
     *            no. of currently running reduce-tasks in the cluster
     * @param max
     *            the maximum no. of tasks in the cluster
     * @param state
     *            the {@link JobTracker.State} of the <code>JobTracker</code>
     */
    ...
    /**
     * Get the current state of the <code>JobTracker</code>, as
     * {@link JobTracker.State}
     * 
