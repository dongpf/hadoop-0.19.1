...
public class StatusHttpServer extends org.apache.hadoop.http.HttpServer {
     ...
     */
    StatusHttpServer(String name, String bindAddress, int port, boolean findPort, Configuration conf)
            throws IOException {
    ...
    public static class TaskGraphServlet extends HttpServlet {
        ...
        public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,
            ...
            // determine the notch interval using the number of digits for
            // numTasks
            ...
            if (reports != null) {
                for (int i = 0, barCnt = 0;; i += tasksPerBar, barCnt++) {
                    ...
                    if (i >= xNotchInterval * xNotchCount) {
                        ...
                        printText(out, x, height + ymargin + 15, String.valueOf(xNotchInterval * xNotchCount++),
                                "middle");
                    }
                    if (i >= reports.length)
                        break;
            ...
            // y axis notches
            for (int i = 0; i <= 10; i++) {
                printLine(out, xmargin - 3, xmargin + 2, ymargin + (i * height) / 10, ymargin + (i * height) / 10,
                        "black");
