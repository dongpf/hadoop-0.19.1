...
class TaskTrackerStatus implements Writable {
    ...
    static class ResourceStatus implements Writable {
        ...
        /**
         * Set the amount of free virtual memory that is available for running a
         * new task
         * 
         * @param freeVMem
         *            amount of free virtual memory in kilobytes
         */
         ...
         * 
         * @param vmem
         *            maximum amount of virtual memory on the tasktracker in
         *            kilobytes.
         */
         ...
         * 
         * If this is {@link JobConf.DISABLED_VIRTUAL_MEMORY_LIMIT}, it should
         * be ignored and not used in any computation.
         * 
         * @return maximum amount of virtual memory on the tasktracker in
         *         kilobytes.
         */
        long getTotalMemory() {
            return totalMemory;
   ...
   */
    ...
    /**
   */
    public TaskTrackerStatus(String trackerName, String host, int httpPort, List<TaskStatus> taskReports, int failures,
   ...
   */
    ...
    /**
     * Get the current tasks at the TaskTracker. Tasks are tracked by a
     * {@link TaskStatus} object.
     * 
     * @return a list of {@link TaskStatus} representing the current tasks at
     *         the TaskTracker.
     */
    ...
    public int countMapTasks() {
        ...
        for (Iterator it = taskReports.iterator(); it.hasNext();) {
            ...
            if (ts.getIsMap()
                    && ((state == TaskStatus.State.RUNNING) || (state == TaskStatus.State.UNASSIGNED) || ts
                            .inTaskCleanupPhase())) {
                mapCount++;
            }
        }
   ...
   */
    ...
    /**
     * Get the maximum concurrent tasks for this node. (This applies per type of
     * task - a node with maxTasks==1 will run up to 1 map and 1 reduce
     * concurrently).
     * 
    ...
    /**
     * Return the {@link ResourceStatus} object configured with this status.
     * 
