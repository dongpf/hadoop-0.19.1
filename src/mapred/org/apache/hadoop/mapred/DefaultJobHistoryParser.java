...
/**
 * Default parser for job history files. It creates object model from job
 * history file.
 * 
 */
public class DefaultJobHistoryParser {
    ...
    // run-time information on generic classes. In particular, we need to be
    // able
     ...
     * 
     * @param jobHistoryFile
     *            history file for this job.
     * @param job
     *            a precreated JobInfo object, should be non-null.
     * @param fs
    ...
    static class JobTasksParseListener implements JobHistory.Listener {
        ...
        private JobHistory.MapAttempt getMapAttempt(String jobid, String jobTrackerId, String taskId,
        ...
        private JobHistory.ReduceAttempt getReduceAttempt(String jobid, String jobTrackerId, String taskId,
                String taskAttemptId) {

            JobHistory.Task task = getTask(taskId);
            JobHistory.ReduceAttempt reduceAttempt = (JobHistory.ReduceAttempt) task.getTaskAttempts().get(
                    taskAttemptId);
