 ...
 * JobID is the job number. <br>
 * An example JobID is : <code>job_200707121733_0003</code> , which represents
 * the third job running at the jobtracker started at <code>200707121733</code>.
 * <p>
 * Applications should never construct or parse JobID strings, but rather use
...
public class JobID extends ID {
    ...
    public String toString() {
        ...
        return builder.append(JOB).append(UNDERSCORE).append(toStringWOPrefix()).toString();
    }

    /** Returns the string representation w/o prefix */
    StringBuilder toStringWOPrefix() {
        StringBuilder builder = new StringBuilder();
        builder.append(jtIdentifier).append(UNDERSCORE).append(idFormat.format(id)).toString();
        return builder;
    }
     ...
     * to obtain a regex matching <i>any job</i> run on the jobtracker started
     * at <i>200707121733</i>, we would use :
     * 
     * <pre>
    ...
    static StringBuilder getJobIDsPatternWOPrefix(String jtIdentifier, Integer jobId) {
        StringBuilder builder = new StringBuilder().append(jtIdentifier != null ? jtIdentifier : "[^_]*")
                .append(UNDERSCORE).append(jobId != null ? idFormat.format(jobId) : "[0-9]*");
        return builder;
    }
