...
class LocalJobRunner implements JobSubmissionProtocol {
    ...
    private class Job extends Thread implements TaskUmbilicalProtocol {
        ...
        public boolean statusUpdate(TaskAttemptID taskId, TaskStatus taskStatus) throws IOException,
        ...
        /**
         * Task is reporting that it is in commit_pending and it is waiting for
         * the commit Response
         */
         ...
         * 
         * @param task
         *            A map or reduce task which has just been successfully
         *            completed
         */
        ...
        public MapTaskCompletionEventsUpdate getMapCompletionEvents(JobID jobId, int fromEventId, int maxLocs,
    ...
    public ClusterStatus getClusterStatus() {
        return new ClusterStatus(1, map_tasks, reduce_tasks, 1, 1, JobTracker.State.RUNNING);
    }
    ...
    /**
     * Returns the diagnostic information for a particular task in the given
