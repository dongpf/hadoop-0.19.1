...
/**
 * A {@link JobInProgressListener} that maintains the jobs being managed in a
 * queue. By default the queue is FIFO, but it is possible to use custom queue
 * ordering by using the {@link #JobQueueJobInProgressListener(Collection)}
 * constructor.
 */
class JobQueueJobInProgressListener extends JobInProgressListener {
     ...
     * 
     * @param jobQueue
     *            A collection whose iterator returns jobs in priority order.
     */
