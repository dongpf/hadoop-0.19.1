...
class BinaryProtocol<K1 extends WritableComparable, V1 extends Writable, K2 extends WritableComparable, V2 extends Writable>
    ...
    private static enum MessageType {
        START(0), SET_JOB_CONF(1), SET_INPUT_TYPES(2), RUN_MAP(3), MAP_ITEM(4), RUN_REDUCE(5), REDUCE_KEY(6), REDUCE_VALUE(
                7), CLOSE(8), ABORT(9), OUTPUT(50), PARTITIONED_OUTPUT(51), STATUS(52), PROGRESS(53), DONE(54), REGISTER_COUNTER(
                55), INCREMENT_COUNTER(56);
        final int code;
    ...
    private static class UplinkReaderThread<K2 extends WritableComparable, V2 extends Writable> extends Thread {
        ...
        private void readObject(Writable obj) throws IOException {
            ...
            byte[] buffer;
            // For BytesWritable and Text, use the specified length to set the
            // length
            // this causes the "obvious" translations to work. So that if you
            // emit
     ...
     * @param value
     *            The object to read values into.
     * @param config
