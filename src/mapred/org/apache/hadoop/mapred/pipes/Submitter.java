...
public class Submitter extends Configured implements Tool {
     ...
     * true, pipes will write a copy of the command data to a file in the task
     * directory named "downlink.data", which may be used to run the C++ program
     * under the debugger. You probably also want to set
     ...
     * modifications to the job to run under pipes are made to the
     * configuration.
     * 
     * @param conf
    ...
    /**
     * Submit a job to the Map-Reduce framework. This returns a handle to the
    ...
    static class CommandLineParser {
        ...
        void addOption(String longName, boolean required, String description, String paramName) {
            ...
            optionList.withOption(option.withLongName(longName).withArgument(arg.create()).withDescription(description)
