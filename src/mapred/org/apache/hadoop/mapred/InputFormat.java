 ...
 * /../hadoop-default.html#mapred.min.split.size"> mapred.min.split.size</a>.
 * </p>
 * 
 * <p>
 ...
 * responsibilty to respect record-boundaries and present a record-oriented view
 * of the logical <code>InputSplit</code> to the individual task.
 * 
 * @see InputSplit
 * @see RecordReader
 * @see JobClient
