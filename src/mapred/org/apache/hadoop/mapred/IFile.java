...
/**
 * <code>IFile</code> is the simple <key-len, key, value-len, value> format for
...
class IFile {
    ...
    public static class Writer<K extends Object, V extends Object> {
        ...
        public Writer(Configuration conf, FileSystem fs, Path file, Class<K> keyClass, Class<V> valueClass,
                CompressionCodec codec) throws IOException {
            this(conf, fs.create(file), keyClass, valueClass, codec);
            ownOutputStream = true;
        }

        public Writer(Configuration conf, FSDataOutputStream out, Class<K> keyClass, Class<V> valueClass,
                CompressionCodec codec) throws IOException {
    ...
    public static class Reader<K extends Object, V extends Object> {
         ...
         * @throws IOException
         */
        public Reader(Configuration conf, FSDataInputStream in, long length, CompressionCodec codec) throws IOException {
