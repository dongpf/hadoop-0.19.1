...
/**************************************************
 * Describes the current status of a job. This is not intended to be a
 * comprehensive piece of data. For that, look at JobProfile.
 **************************************************/
public class JobStatus implements Writable, Cloneable {
   ...
   */
     ...
     *            Priority of the job.
     */
    public JobStatus(JobID jobid, float setupProgress, float mapProgress, float reduceProgress, float cleanupProgress,
     ...
     * 
     * @param p
     *            The value of cleanup progress to set to
     */
     ...
     * 
     * @param p
     *            The value of reduce progress to set to
     */
     ...
     *            Scheduling information of the job
     */
