...
public class JobEndNotifier {
    ...
    private static BlockingQueue<JobEndStatusInfo> queue = new DelayQueue<JobEndStatusInfo>();
    ...
    private static JobEndStatusInfo createNotification(JobConf conf, JobStatus status) {
        ...
        if (uri != null) {
            ...
            if (uri.contains("$jobStatus")) {
                String statusStr = (status.getRunState() == JobStatus.SUCCEEDED) ? "SUCCEEDED" : "FAILED";
