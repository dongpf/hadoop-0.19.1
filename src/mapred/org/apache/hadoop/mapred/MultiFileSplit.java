 ...
 * class does not represent a split of a file, but a split of input files into
 * smaller sets. The atomic unit of split is a file. <br>
 * MultiFileSplit can be used to implement {@link RecordReader}'s, with reading
 * one record per file.
 * 
 * @see FileSplit
