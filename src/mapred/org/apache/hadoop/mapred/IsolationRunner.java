...
public class IsolationRunner {
    ...
    /**
     * Create empty sequence files for any of the map outputs that we don't
     * have.
     * 
     * @param fs
     *            the filesystem to create the files in
     * @param dir
     *            the directory name to create the files in
     * @param conf
     *            the jobconf
     * @throws IOException
     *             if something goes wrong writing
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        File workDirName = new File(lDirAlloc.getLocalPathToRead(
                TaskTracker.getLocalTaskDir(taskId.getJobID().toString(), taskId.toString()) + Path.SEPARATOR + "work",
                conf).toString());
