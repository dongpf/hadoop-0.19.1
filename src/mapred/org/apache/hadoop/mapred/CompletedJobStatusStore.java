 ...
 * <p/>
 * The retain time can be set with the 'persist.jobstatus.hours' configuration
 * variable (it is in hours).
 */
class CompletedJobStatusStore implements Runnable {
        ...
        try {
            ...
            for (FileStatus jobInfo : jobInfoFiles) {
                try {
                    ...
                    LOG.warn(
                            "Could not do housekeeping for [ " + jobInfo.getPath() + "] job info : " + ie.getMessage(),
                            ie);
                }
            }
        } catch (IOException ie) {
    ...
    /**
     * This method retrieves JobStatus information from DFS stored using store
     * method.
     * 
     * @param jobId
    ...
    /**
     * This method retrieves JobProfile information from DFS stored using store
     * method.
     * 
     * @param jobId
    ...
    /**
     * This method retrieves Counters information from DFS stored using store
     * method.
     * 
     * @param jobId
