...
/**
 * {@link JobStatusChangeEvent} tracks the change in job's status. Job's status
 * can change w.r.t - run state i.e PREP, RUNNING, FAILED, KILLED, SUCCEEDED -
 * start time - priority Note that job times can change as the job can get
 * restarted.
 */
