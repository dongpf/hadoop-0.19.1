...
public class Job {
     ...
     * 
     * @param jobConf
     *            a mapred job configuration representing a job to be executed.
     * @param dependingJobs
     ...
     * 
     * @param jobConf
     *            the mapred job conf for this job.
     */
    ...
    public boolean isCompleted() {
        return this.state == Job.FAILED || this.state == Job.DEPENDENT_FAILED || this.state == Job.SUCCESS;
    }
