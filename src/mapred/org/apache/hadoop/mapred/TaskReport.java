...
public class TaskReport implements Writable {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass().equals(TaskReport.class)) {
            ...
            return counters.contentEquals(report.getCounters())
                    ...
                    && this.finishTime == report.getFinishTime() && this.progress == report.getProgress()
                    && this.startTime == report.getStartTime() && this.state.equals(report.getState())
    ...
    @Override
    public int hashCode() {
        return (counters.toString() + Arrays.toString(this.diagnostics) + this.finishTime + this.progress
                + this.startTime + this.state + this.taskid.toString()).hashCode();
    }
