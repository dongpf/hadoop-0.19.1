 ...
 */
public class WrappedRecordReader<K extends WritableComparable, U extends Writable> implements
        ComposableRecordReader<K, U> {
    ...
    /**
     * Read the next k,v pair into the head of this object; return true iff the
     * RR and this are exhausted.
     */
    ...
    /**
     * Implement Comparable contract (compare key at head of proxied RR with
     * that of another).
     */
