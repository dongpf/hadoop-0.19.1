 ...
 */
public abstract class MultiFilterRecordReader<K extends WritableComparable, V extends Writable> extends
        CompositeRecordReader<K, V, V> implements ComposableRecordReader<K, V> {
    ...
    /**
     * For each tuple emitted, return a value (typically one of the values in
     * the tuple). Modifying the Writables in the tuple is permitted and
     * unlikely to affect join behavior in most cases, but it is not
     * recommended. It's safer to clone first.
     */
