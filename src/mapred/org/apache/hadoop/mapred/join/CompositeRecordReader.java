...
X extends Writable> // emits Writables of this type
     ...
     * <tt>id</tt> in the parent reader. The id of a root CompositeRecordReader
     * is -1 by convention, but relying on this is not recommended.
     */
    ...
    /**
     * Collector for join values. This accumulates values for a given key from
     * the child RecordReaders. If one or more child RR contain duplicate keys,
     * this will emit the cross product of the associated values until
     * exhausted.
     */
    class JoinCollector {
        private K key;
        ...
        /**
         * Codify the contents of the collector to be iterated over. When this
         * is called, all RecordReaders registered for this key should have
         * added ResetableIterators.
         */
    ...
    public void accept(CompositeRecordReader.JoinCollector jc, K key) throws IOException {
