...
public abstract class JoinRecordReader<K extends WritableComparable> extends
        CompositeRecordReader<K, Writable, TupleWritable> implements ComposableRecordReader<K, TupleWritable> {
    ...
    /**
     * Since the JoinCollector is effecting our operation, we need only provide
     * an iterator proxy wrapping its operation.
     */
