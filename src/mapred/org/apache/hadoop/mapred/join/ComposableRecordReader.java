 ...
 */
public interface ComposableRecordReader<K extends WritableComparable, V extends Writable> extends RecordReader<K, V>,
        Comparable<ComposableRecordReader<K, ?>> {
    ...
    /**
     * While key-value pairs from this RecordReader match the given key,
     * register them with the JoinCollector provided.
     */
