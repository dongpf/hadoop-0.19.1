 ...
 * {@link KeyFieldBasedComparator}. The key specification supported is of the
 * form -k pos1[,pos2], where, pos is of the form f[.c][opts], where f is the
 * number of the key field to use, and c is the number of the first character
 * from the beginning of the field. Fields and character posns are numbered
