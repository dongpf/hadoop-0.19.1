...
public interface ValueAggregatorDescriptor {
    ...
    /**
     * Generate a list of aggregation-id/value pairs for the given key/value
     * pair. This function is usually called by the mapper of an Aggregate based
     * job.
     * 
     * @param key
     *            input key
     * @param val
     *            input value
     * @return a list of aggregation id/value pairs. An aggregation id encodes
     *         an aggregation type which is used to guide the way to aggregate
     *         the value in the reduce/combiner phrase of an Aggregate based
     *         job.
     */
     ...
     * 
     * @param job
     *            a JobConf object that may contain the information that can be
