 ...
 */
public class ValueAggregatorCombiner<K1 extends WritableComparable, V1 extends Writable> extends
     ...
     *            indicates the type of aggregation to aggregate the values.
     * @param values
