...
public class ValueAggregatorBaseDescriptor implements ValueAggregatorDescriptor {
     ...
     * type will be generated too, with the file name as its aggregation id.
     * This achieves the behavior of counting the total number of records in the
     * input data, and the number of records in each input file.
     * 
     * @param key
     *            input key
     * @param val
