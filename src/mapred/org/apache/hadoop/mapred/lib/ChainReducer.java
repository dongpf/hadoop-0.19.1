...
public class ChainReducer implements Reducer {
     ...
     * the chain to the next, by value or by reference. If a Reducer leverages
     * the assumed semantics that the key and values are not modified by the
     * collector 'by value' must be used. If the Reducer does not expect this
     * semantics, as an optimization to avoid serialization and deserialization
     ...
     * 
     * @param job
     *            job's JobConf to add the Reducer class.
     * @param klass
    ...
    public static <K1, V1, K2, V2> void setReducer(JobConf job, Class<? extends Reducer<K1, V1, K2, V2>> klass,
        ...
        Chain.setReducer(job, klass, inputKeyClass, inputValueClass, outputKeyClass, outputValueClass, byValue,
                reducerConf);
    }
     ...
     * <p/>
     * It has to be specified how key and values are passed from one element of
     * the chain to the next, by value or by reference. If a Mapper leverages
     * the assumed semantics that the key and values are not modified by the
     * collector 'by value' must be used. If the Mapper does not expect this
     * semantics, as an optimization to avoid serialization and deserialization
     * 'by reference' can be used.
     * <p/>
    ...
    public static <K1, V1, K2, V2> void addMapper(JobConf job, Class<? extends Mapper<K1, V1, K2, V2>> klass,
        ...
        job.setOutputKeyClass(outputKeyClass);
        job.setOutputValueClass(outputValueClass);
        Chain.addMapper(false, job, klass, inputKeyClass, inputValueClass, outputKeyClass, outputValueClass, byValue,
                mapperConf);
    }
    ...
    /**
     * Configures the ChainReducer, the Reducer and all the Mappers in the
     * chain.
     * <p/>
     ...
     * <p/>
     * If this method is overriden <code>super.close()</code> should be invoked
     * at the end of the overwriter method.
     */
