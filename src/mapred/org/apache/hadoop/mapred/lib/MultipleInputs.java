...
public class MultipleInputs {
    ...
    public static void addInputPath(JobConf conf, Path path, Class<? extends InputFormat> inputFormatClass) {
        ...
        conf.set("mapred.input.dir.formats", inputFormats == null ? inputFormatMapping : inputFormats + ","
                + inputFormatMapping);
    ...
    /**
     * Add a {@link Path} with a custom {@link InputFormat} and {@link Mapper}
    ...
    /**
     * Retrieves a map of {@link Path}s to the {@link InputFormat} class that
    ...
    /**
     * Retrieves a map of {@link Path}s to the {@link Mapper} class that should
     * be used for them.
     * 
     * @param conf
     *            The confuration of the job
