...
public class MetricsUtil {
    ...
    /**
     * Utility method to return the named context. If the desired context cannot
     * be created for any reason, the exception is logged, and a null context is
     * returned.
     */
     ...
     * the given context. This record is tagged with the host name.
     * 
     * @param context
     *            the context
     * @param recordName
