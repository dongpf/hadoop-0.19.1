...
/**
 * The MetricsLongValue class is for a metric that is not time varied but
 * changes only when it is set. Each time its value is set, it is published only
 * *once* at the next update call.
 * 
 */
