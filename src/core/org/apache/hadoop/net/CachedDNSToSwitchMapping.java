...
/**
 * A cached implementation of DNSToSwitchMapping that takes an raw
 * DNSToSwitchMapping and stores the resolved network location in a cache. The
 * following calls to a resolved network location will get its location from the
 * cache.
 * 
 */
