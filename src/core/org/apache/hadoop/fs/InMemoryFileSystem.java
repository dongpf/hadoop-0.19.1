...
public class InMemoryFileSystem extends ChecksumFileSystem {
    private static class RawInMemoryFileSystem extends FileSystem {
        ...
        // pathToFileAttribs is the final place where a file is put after it is
        // closed
        private Map<String, FileAttributes> pathToFileAttribs = new HashMap<String, FileAttributes>();

        // tempFileAttribs is a temp place which is updated while reserving
        // memory for
        // files we are going to create. It is read in the createRaw method and
        // the
        ...
        public FSDataOutputStream create(Path f, FileAttributes fAttr) throws IOException {
            // the path is not added into the filesystem (in the
            // pathToFileAttribs
            // map) until close is called on the outputstream that this method
            // is
            // going to return
         ...
         * but it is an overhead to maintain directory structures for this impl
         * of the in-memory fs.
         */
        ...
        /**
         * @TODO: Fix for Java6? As of Java5 it is safe to assume that if the
         *        file can fit in-memory then its file-size is less than
         *        Integer.MAX_VALUE.
         */
