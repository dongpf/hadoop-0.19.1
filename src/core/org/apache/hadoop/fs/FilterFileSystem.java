...
/****************************************************************
 * A <code>FilterFileSystem</code> contains some other file system, which it
 * uses as its basic file system, possibly transforming the data along the way
 * or providing additional functionality. The class
 * <code>FilterFileSystem</code> itself simply overrides all methods of
 * <code>FileSystem</code> with versions that pass all requests to the contained
 * file system. Subclasses of <code>FilterFileSystem</code> may further override
