...
public class SequenceFileInputStream extends InputStream {
    ...
    public SequenceFileInputStream(FileSystem fs, Path f, Configuration jobConf) throws IOException {
        ...
        key = ReflectionUtils.newInstance(r.getKeyClass().asSubclass(WritableComparable.class), jobConf);
        val = ReflectionUtils.newInstance(r.getValueClass().asSubclass(Writable.class), jobConf);
