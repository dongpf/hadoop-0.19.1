...
public class FileUtil {
    ...
    /**
     * convert an array of FileStatus to an array of Path. If stats if null,
     * return path
     * 
     * @param stats
     *            an array of FileStatus objects
     ...
     * 
     * @param fs
     *            {@link FileSystem} on which the path is present
     * @param dir
    ...
    public static void replaceFile(File src, File target) throws IOException {
         ...
         * src.renameTo(target) fails if 1) If target already exists OR 2) If
         * target is already open for reading/writing.
         */
