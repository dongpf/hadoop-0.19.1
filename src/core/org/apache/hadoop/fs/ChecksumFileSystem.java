...
/****************************************************************
 * Abstract Checksumed FileSystem. It provide a basice implementation of a
 * Checksumed FileSystem, which creates a checksum file for each raw file. It
 * generates & verifies checksums at the client side.
 * 
 *****************************************************************/
public abstract class ChecksumFileSystem extends FilterFileSystem {
    ...
    private static class ChecksumFSInputChecker extends FSInputChecker {
        ...
        public ChecksumFSInputChecker(ChecksumFileSystem fs, Path file, int bufferSize) throws IOException {
            ...
            try {
                ...
                LOG.warn("Problem opening checksum file: " + file + ".  Ignoring exception: "
         ...
         * when reaching end of file before <code>n</code> bytes have been
         * skipped. The actual number of bytes skipped is returned. If
         ...
         *                if an I/O error occurs. ChecksumException if the chunk
         *                to skip to is corrupted
         */
        ...
        /**
         * Seek to the given position in the stream. The next read() will be
         * from that position.
         * 
         * <p>
         * This method does not allow seek past the end of the file. This
         * produces IOException.
         * 
         * @param pos
    ...
    /**
     * This class provides an output stream for a checksummed file. It generates
     * checksums for data.
     */
    private static class ChecksumFSOutputSummer extends FSOutputSummer {
        ...
        public ChecksumFSOutputSummer(ChecksumFileSystem fs, Path file, boolean overwrite, short replication,
                long blockSize, Configuration conf) throws IOException {
        ...
        public ChecksumFSOutputSummer(ChecksumFileSystem fs, Path file, boolean overwrite, int bufferSize,
            ...
            this.sums = fs.getRawFileSystem().create(fs.getChecksumFile(file), true, sumBufferSize, replication,
                    blockSize);
    ...
    public FSDataOutputStream create(Path f, FsPermission permission, boolean overwrite, int bufferSize,
        ...
        final FSDataOutputStream out = new FSDataOutputStream(new ChecksumFSOutputSummer(this, f, overwrite,
    ...
    /**
     * Set replication for an existing file. Implement the abstract
     * <tt>setReplication</tt> of <tt>FileSystem</tt>
     * 
     * @param src
     *            file name
     * @param replication
    ...
    /**
     * The src file is under FS, and the dst is on the local disk. Copy it from
     * FS control to the local dst name. If src and dst are directories, the
     * copyCrc parameter determines whether to copy CRC files.
     */
     ...
     * @param sumsPos
     *            the position of the beginning of the bad data in the checksum
     *            file
