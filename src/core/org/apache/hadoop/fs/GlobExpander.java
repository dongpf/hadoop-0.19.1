...
class GlobExpander {
    ...
    /**
     * Expand the leftmost outer curly bracket pair containing a slash character
     * ("/") in <code>filePattern</code>.
     * 
     * @param filePattern
     * @return expanded file patterns
     * @throws IOException
    ...
    /**
     * Finds the index of the leftmost opening curly bracket containing a slash
     * character ("/") in <code>filePattern</code>.
     * 
     * @param filePattern
