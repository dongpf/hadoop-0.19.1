...
public class Client {
    ...
    private class Connection extends Thread {
        ...
        public Connection(ConnectionId remoteId) throws IOException {
            ...
            this.setName("IPC Client (" + socketFactory.hashCode() + ") connection to "
                    + remoteId.getAddress().toString() + " from "
        ...
        private synchronized void setupIOstreams() {
            ...
            try {
                ...
                this.in = new DataInputStream(new BufferedInputStream(new PingInputStream(
        ...
        private void handleConnectionFailure(int curRetries, int maxRetries, IOException ioe) throws IOException {
            ...
            LOG.info("Retrying connect to server: " + remoteId.getAddress() + ". Already tried " + curRetries
                    + " time(s).");
        }

        /*
         * Write the header for each connection Out is not synchronized because
        ...
        private void writeHeader() throws IOException {
            ...
            ObjectWritable.writeObject(buf, remoteId.getTicket(), UserGroupInformation.class, conf);
     ...
     */
    private Connection getConnection(InetSocketAddress addr, UserGroupInformation ticket, Call call) throws IOException {
        if (!running.get()) {
