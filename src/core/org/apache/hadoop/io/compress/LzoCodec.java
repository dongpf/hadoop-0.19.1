...
public class LzoCodec implements Configurable, CompressionCodec {
    ...
    public CompressionOutputStream createOutputStream(OutputStream out, Compressor compressor) throws IOException {
        ...
        LzoCompressor.CompressionStrategy strategy = LzoCompressor.CompressionStrategy.valueOf(conf.get(
    ...
    public CompressionInputStream createInputStream(InputStream in, Decompressor decompressor) throws IOException {
        ...
        return new BlockDecompressorStream(in, decompressor, conf.getInt("io.compression.codec.lzo.buffersize",
                64 * 1024));
    }
    ...
    public Decompressor createDecompressor() {
        ...
        LzoDecompressor.CompressionStrategy strategy = LzoDecompressor.CompressionStrategy.valueOf(conf.get(
                "io.compression.codec.lzo.decompressor", LzoDecompressor.CompressionStrategy.LZO1X.name()));
        int bufferSize = conf.getInt("io.compression.codec.lzo.buffersize", 64 * 1024);
