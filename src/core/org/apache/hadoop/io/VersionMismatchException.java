...
/**
 * Thrown by {@link VersionedWritable#readFields(DataInput)} when the version of
 * an object being read does not match the current implementation version as
 * returned by {@link VersionedWritable#getVersion()}.
 */
