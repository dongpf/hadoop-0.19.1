...
public class WritableComparator implements RawComparator {
     ...
     * 
     * <p>
     * The default implementation reads the data into two
     * {@link WritableComparable}s (using {@link Writable#readFields(DataInput)}
     * , then calls {@link #compare(WritableComparable,WritableComparable)}.
     */
    // NOTE
    // WritableComparator.compare中比较逻辑为：首先从流中反序列化key实例，再调用key的compareTo方法比较。自定义的Writable类中可以覆盖该方法来提供更优化的比较性能。参考LongWritable
     ...
     * 
     * <p>
     * The default implementation uses the natural ordering, calling
