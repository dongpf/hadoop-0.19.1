...
public class WritableName {
    private static HashMap<String, Class<?>> NAME_TO_CLASS = new HashMap<String, Class<?>>();
    private static HashMap<Class<?>, String> CLASS_TO_NAME = new HashMap<Class<?>, String>();
    ...
    public static synchronized Class<?> getClass(String name, Configuration conf) throws IOException {
        ...
        if (writableClass != null)
            // NOTE asSubclass
            // 通常在向某些参数严格限制的API传递参数时，为了避免产生编译警告，适应API中方法接受的参数，这个方法比较有用
