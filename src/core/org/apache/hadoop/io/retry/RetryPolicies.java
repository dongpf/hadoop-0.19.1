...
public class RetryPolicies {
    ...
    /**
     * <p>
     * Try once, and fail by re-throwing the exception. This corresponds to
     * having no retry mechanism in place.
     * </p>
     */
     ...
     * attempts, and then fail by re-throwing the exception.
     * </p>
     */
     ...
     * between attempts, and then fail by re-throwing the exception. The time
     * between attempts is <code>sleepTime</code> mutliplied by the number of
     * tries so far.
     * </p>
     */
     ...
     * Keep trying a limited number of times, waiting a growing amount of time
     * between attempts, and then fail by re-throwing the exception. The time
     * between attempts is <code>sleepTime</code> mutliplied by a random number
     * in the range of [0, 2 to the number of retries)
     * </p>
     */
    ...
    /**
     * <p>
     * A retry policy for RemoteException Set a default policy with some
     * explicit handlers for specific exceptions.
     * </p>
     */
