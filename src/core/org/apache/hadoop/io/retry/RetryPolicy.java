...
/**
 * <p>
 * Specifies a policy for retrying method failures. Implementations of this
 * interface should be immutable.
 * </p>
 */
public interface RetryPolicy {
     ...
     * exception, and the number of retries that have been made for that
     * operation so far.
     * </p>
     * 
     * @param e
     ...
     * @throws Exception
     *             The re-thrown exception <code>e</code> indicating that the
     *             method failed and should not be retried further.
     */
