...
public class HttpServer implements FilterContainer {
    ...
    protected final Map<WebApplicationContext, Boolean> defaultContexts = new HashMap<WebApplicationContext, Boolean>();
    ...
    public void addFilter(String name, String classname, Map<String, String> parameters) {
        ...
        for (Map.Entry<WebApplicationContext, Boolean> e : defaultContexts.entrySet()) {
            if (e.getValue()) {
                WebApplicationContext ctx = e.getKey();
                defineFilter(ctx, name, classname, parameters, ALL_URLS);
                LOG.info("Added filter " + name + " (class=" + classname + ") to context " + ctx.getName());
            }
        }
     ...
     */
    protected void defineFilter(WebApplicationContext ctx, String name, String classname,
