...
public class DistributedCache {
     ...
     * @throws IOException
     */
    public static Path getLocalCache(URI cache, Configuration conf, Path baseDir, FileStatus fileStatus,
            boolean isArchive, long confFileStamp, Path currentWorkDir) throws IOException {
     ...
     */
    public static Path getLocalCache(URI cache, Configuration conf, Path baseDir, FileStatus fileStatus,
            boolean isArchive, long confFileStamp, Path currentWorkDir, boolean honorSymLinkConf) throws IOException {
        ...
        synchronized (cachedArchives) {
            ...
            synchronized (lcacheStatus) {
                localizedPath = localizeCache(conf, cache, confFileStamp, lcacheStatus, fileStatus, isArchive,
     ...
     * @throws IOException
     */
    public static Path getLocalCache(URI cache, Configuration conf, Path baseDir, boolean isArchive,
    ...
    private static Path localizeCache(Configuration conf, URI cache, long confFileStamp, CacheStatus cacheStatus,
            FileStatus fileStatus, boolean isArchive, Path currentWorkDir, boolean honorSymLinkConf) throws IOException {
    ...
    private static boolean ifExistsAndFresh(Configuration conf, FileSystem fs, URI cache, long confFileStamp,
    ...
    public static void setFileLength(Configuration conf, String length) {
        conf.set("mapred.cache.files.length", length);
    }

    public static String[] getFileLength(Configuration conf) {
        return conf.getStrings("mapred.cache.files.length");
    }

    public static void setArchiveLength(Configuration conf, String length) {
        conf.set("mapred.cache.archives.length", length);
    }

    public static String[] getArchiveLength(Configuration conf) {
        return conf.getStrings("mapred.cache.archives.length");
    }
    ...
    public static void addFileToClassPath(Path file, Configuration conf) throws IOException {
        ...
        conf.set(
                ...
                classpath == null ? file.toString() : classpath + System.getProperty("path.separator")
                        + file.toString());
    ...
    public static void addArchiveToClassPath(Path archive, Configuration conf) throws IOException {
        ...
        conf.set(
                ...
                classpath == null ? archive.toString() : classpath + System.getProperty("path.separator")
                        + archive.toString());
        FileSystem fs = FileSystem.get(conf);
