...
abstract public class JType {
    ...
    abstract class JavaType {
        ...
        void genStaticTypeInfo(CodeBuffer cb, String fname) {
            cb.append(Consts.RTI_VAR + ".addField(\"" + fname + "\", " + getTypeIDObjectString() + ");\n");
        }
         ...
         * cb.append("if ((tInfo.fieldID.equals(\"" + fname +
         * "\")) && (typeVal ==" + " org.apache.hadoop.record.meta." +
         * getTypeIDByteString() + ")) {\n"); cb.append("rtiFilterFields[i] = "
         * + ct + ";\n"); cb.append("}\n"); }
         * 
         * void genRtiNestedFieldCondition(CodeBuffer cb, String varName, int
         * ct) { cb.append("if (" + varName +
         * ".getElementTypeID().getTypeVal() == " +
        ...
        void genWriteMethod(CodeBuffer cb, String fname, String tag) {
            cb.append(Consts.RECORD_OUTPUT + ".write" + methodSuffix + "(" + fname + ",\"" + tag + "\");\n");
        }
        ...
        void genCompareTo(CodeBuffer cb, String fname, String other) {
            cb.append(Consts.RIO_PREFIX + "ret = (" + fname + " == " + other + ")? 0 :((" + fname + "<" + other
                    + ")?-1:1);\n");
        }
    ...
    abstract class CppType {
        ...
        void genStaticTypeInfo(CodeBuffer cb, String fname) {
            cb.append("p->addField(new ::std::string(\"" + fname + "\"), " + getTypeIDObjectString() + ");\n");
        }
