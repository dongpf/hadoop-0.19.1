...
/**
 * Utility to assist with generation of progress reports. Applications build a
 * hierarchy of {@link Progress} instances, each modelling a phase of execution.
 * The root is constructed with {@link #Progress()}. Nodes for sub-phases are
 * created by calling {@link #addPhase()}.
 */
public class Progress {
    ...
    public void complete() {
        ...
        if (myParent != null) {
            ...
            // against the normal traversal direction used by get() or
            // toString().
