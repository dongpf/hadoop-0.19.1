 ...
 * arguments, enabling applications to easily specify a namenode, a jobtracker,
...
public class GenericOptionsParser {
    ...
    private static Options buildGeneralOptions(Options opts) {
        ...
        Option property = OptionBuilder.withArgName("property=value").hasArgs().withArgPattern("=", 1)
    ...
    private void processGeneralOptions(Configuration conf, CommandLine line) {
        ...
        try {
            if (line.hasOption("libjars")) {
                ...
                ClassLoader loader = new URLClassLoader(getLibJars(conf), conf.getClassLoader());
