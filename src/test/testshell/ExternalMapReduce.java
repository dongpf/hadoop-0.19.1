...
/**
 * will be in an external jar and used for test in TestJobShell.java.
 */
public class ExternalMapReduce extends Configured implements Tool {
    ...
    public static class MapClass extends MapReduceBase implements
            Mapper<WritableComparable, Writable, WritableComparable, IntWritable> {
    ...
    public static class Reduce extends MapReduceBase implements
            Reducer<WritableComparable, Writable, WritableComparable, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (commandConf != null) {
            ToolRunner.run(new Configuration(commandConf), new ExternalMapReduce(), args);
        } else {
            ToolRunner.run(new Configuration(), new ExternalMapReduce(), args);
        }
    }
}
