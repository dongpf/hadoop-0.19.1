...
public class TestFileSystem extends TestCase {
    ...
    public static void createControlFile(FileSystem fs, long megaBytes, int numFiles, long seed) throws Exception {
        ...
        SequenceFile.Writer writer = SequenceFile.createWriter(fs, conf, controlFile, UTF8.class, LongWritable.class,
    ...
    public static class WriteMapper extends Configured implements Mapper<UTF8, LongWritable, UTF8, LongWritable> {
        ...
        public void map(UTF8 key, LongWritable value, OutputCollector<UTF8, LongWritable> collector, Reporter reporter)
                throws IOException {
    ...
    public static class ReadMapper extends Configured implements Mapper<UTF8, LongWritable, UTF8, LongWritable> {
    ...
    public static class SeekMapper<K> extends Configured implements
            Mapper<WritableComparable, LongWritable, K, LongWritable> {
        ...
        public void map(WritableComparable key, LongWritable value, OutputCollector<K, LongWritable> collector,
    ...
    public void testFsCache() throws Exception {
        {
            ...
            Configuration[] conf = { new Configuration(), createConf4Testing("foo" + now),
                    createConf4Testing("bar" + now) };
