...
public class TestTrash extends TestCase {
    ...
    private final static Path TEST_DIR = new Path(new File(System.getProperty("test.build.data", "/tmp")).toURI()
    ...
    protected static void checkTrash(FileSystem fs, Path trashRoot, String pathname) throws IOException {
    ...
    protected static void trashShell(final FileSystem fs, final Path base) throws IOException {
    ...
    public static void trashNonDefaultFS(Configuration conf) throws IOException {
        ...
        // attempt non-default FileSystem trash
        {
            ...
            try {
                ...
                FileSystem.closeAll();
                Trash lTrash = new Trash(FileSystem.get(URI.create("file:///"), conf), conf);
