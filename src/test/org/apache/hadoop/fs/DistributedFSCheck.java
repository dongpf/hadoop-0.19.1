 ...
 * <p>
 * Test file system consistency by reading each block of each file of the
 * specified file tree. Report corrupted blocks and general file statistics.
 * <p>
...
public class DistributedFSCheck extends TestCase {
    ...
    private static Path TEST_ROOT_DIR = new Path(
            System.getProperty("test.build.data", "/benchmarks/DistributedFSCheck"));
    ...
    private void createInputFile(String rootName) throws IOException {
        ...
        SequenceFile.Writer writer = SequenceFile.createWriter(fs, fsConfig, inputFile, UTF8.class, LongWritable.class,
    ...
    public static class DistributedFSCheckMapper extends IOMapperBase {
        ...
        void collectStats(OutputCollector<UTF8, UTF8> output, String name, long execTime, Object corruptedBlock)
                throws IOException {
