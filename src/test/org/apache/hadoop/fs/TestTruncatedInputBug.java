...
public class TestTruncatedInputBug extends TestCase {
    ...
    /**
     * When mark() is used on BufferedInputStream, the request size on the
     * checksum file system can be small. However, checksum file system
     * currently depends on the request size >= bytesPerSum to work properly.
     */
