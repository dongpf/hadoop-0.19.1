...
public class TestIndexedSort extends TestCase {
    ...
    public void testQuickSort() throws Exception {
        ...
        System.out.println("QuickSort degen cmp/swp: " + m.getCmp() + "/" + m.getSwp() + "("
    ...
    private static class WritableSortable implements IndexedSortable {
        ...
        public int compare(int i, int j) {
            ...
            return comparator.compare(bytes, offsets[ii], ((ii + 1 == indices.length) ? eob : offsets[ii + 1])
                    - offsets[ii], bytes, offsets[ij], ((ij + 1 == indices.length) ? eob : offsets[ij + 1])
                    - offsets[ij]);
        }
