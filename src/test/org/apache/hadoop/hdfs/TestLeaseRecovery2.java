...
public class TestLeaseRecovery2 extends junit.framework.TestCase {
    ...
    public void testBlockSynchronization() throws Exception {
        ...
        try {
            ...
            // namenode triggers lease recovery on next attempt to
            // write-for-open.
            ...
            AppendTestUtil.LOG
                    .info("Lease for file " + filepath + " is recovered. " + "Validating its contents now...");

            // verify that file-size matches
            assertTrue(
                    "File should be " + size + " bytes, but is actually " + " found to be "
                            + dfs.getFileStatus(filepath).getLen() + " bytes",
