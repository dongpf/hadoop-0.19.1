...
public class CreateEditsLog {
    ...
    static void addFiles(FSEditLog editLog, int numFiles, short replication, int blocksPerFile, long startingBlockId,
        ...
        for (int iF = 0; iF < numFiles; iF++) {
            ...
            try {
                ...
                INodeFileUnderConstruction inode = new INodeFileUnderConstruction(null, replication, 0, blockSize,
                        blocks, p, "", "", null);
                // Append path to filename with information about blockIDs
                String path = "_" + iF + "_B" + blocks[0].getBlockId() + "_to_B"
                        + blocks[blocksPerFile - 1].getBlockId() + "_";
    ...
    static String usage = "Usage: createditlogs "
            + " -f  numFiles startingBlockIds NumBlocksPerFile  [-r replicafactor] " + "[-d editsLogDirectory]\n"
