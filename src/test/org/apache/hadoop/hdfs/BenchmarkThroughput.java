 ...
 * file system and HDFS at reading and writing files. The user should invoke the
 * main of this class and optionally include a repetition count.
 */
public class BenchmarkThroughput extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new BenchmarkThroughput(), args);
        System.exit(res);
    }
