 ...
 * system when the system is rolled back under various storage state and version
 * conditions.
 */
public class TestDFSRollback extends TestCase {
    ...
    /**
     * Verify that the new current directory is the old previous. It is assumed
     * that the server has recovered and rolled back.
     */
    ...
    /**
     * This test attempts to rollback the NameNode and DataNode under a number
    ...
    public void testRollback() throws Exception {
        ...
        for (int numDirs = 1; numDirs <= 2; numDirs++) {
            ...
            UpgradeUtilities.createVersionFile(
                    NAME_NODE,
                    baseDirs,
                    new StorageInfo(1, UpgradeUtilities.getCurrentNamespaceID(null), UpgradeUtilities
