...
/**
 * This test checks correctness of port usage by hdfs components: NameNode,
...
public class TestHDFSServerPorts extends TestCase {
    ...
    public void testSecondaryNodePorts() throws Exception {
        ...
        try {
            ...
            // bind http server to the same port as name-node
            Configuration conf2 = new Configuration(config);
            conf2.set("dfs.secondary.http.address", config.get("dfs.http.address"));
            SecondaryNameNode.LOG.info("= Starting 1 on: " + conf2.get("dfs.secondary.http.address"));
            ...
            SecondaryNameNode.LOG.info("= Starting 2 on: " + conf2.get("dfs.secondary.http.address"));
