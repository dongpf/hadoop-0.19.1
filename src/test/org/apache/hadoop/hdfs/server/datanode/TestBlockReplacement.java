...
public class TestBlockReplacement extends TestCase {
    ...
    public void testBlockReplacement() throws IOException {
        ...
        try {
            ...
            // case 3: correct case
            LOG.info("Testcase 3: Proxy=" + source.getName() + " source=" + proxies.get(0).getName() + " destination="
                    + newNode.getName());
            ...
            /*
             * block locations should contain two proxies, and either of source
             * or newNode
             */
    ...
    private void checkBlocks(DatanodeInfo[] includeNodes, String fileName, long fileLen, short replFactor,
        ...
        do {
            ...
            List<LocatedBlock> blocks = client.namenode.getBlockLocations(fileName, 0, fileLen).getLocatedBlocks();
     ...
     */
    private boolean replaceBlock(Block block, DatanodeInfo source, DatanodeInfo sourceProxy, DatanodeInfo destination)
            throws IOException {
