...
public class TestFsck extends TestCase {
    ...
    public void testFsckMove() throws Exception {
        ...
        try {
            ...
            String block = dfsClient.namenode.getBlockLocations(fileNames[0], 0, Long.MAX_VALUE).get(0).getBlock()
                    .getBlockName();
    ...
    public void testFsckOpenFiles() throws Exception {
        ...
        try {
            ...
            // Close the file
            out.close();
            // Now, fsck should show HEALTHY fs and should not show any open
            // files
            outStr = runFsck(conf, 0, true, topDir);
            System.out.println(outStr);
            assertTrue(outStr.contains("HEALTHY"));
