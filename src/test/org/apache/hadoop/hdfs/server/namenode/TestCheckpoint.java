...
public class TestCheckpoint extends TestCase {
    ...
    /**
     * Simulate a secondary node failure to transfer image back to the
     * name-node. Used to truncate primary fsimage file.
     */
     ...
     * <li>Start of secondary node when the primary is already running in this
     * directory must fail.
     ...
     * <li>Import of a checkpoint must fail if primary directory contains a
     * valid image.
    ...
    NameNode startNameNode(Configuration conf, String imageDirs, String editsDirs, StartupOption start)
            throws IOException {
