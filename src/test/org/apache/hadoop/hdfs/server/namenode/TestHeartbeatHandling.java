...
public class TestHeartbeatHandling extends TestCase {
    /**
     * Test if
     * {@link FSNamesystem#handleHeartbeat(DatanodeRegistration, long, long, long, int, int)}
    ...
    public void testHeartbeat() throws Exception {
        ...
        try {
            ...
            synchronized (namesystem.heartbeats) {
                ...
                DatanodeCommand[] cmds = namesystem.handleHeartbeat(nodeReg, dd.getCapacity(), dd.getDfsUsed(),
                        dd.getRemaining(), 0, 0);
