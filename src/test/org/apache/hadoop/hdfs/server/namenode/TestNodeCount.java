...
public class TestNodeCount extends TestCase {
    public void testNodeCount() throws Exception {
        ...
        final MiniDFSCluster cluster = new MiniDFSCluster(conf, REPLICATION_FACTOR, true, null);
        try {
            ...
            DatanodeDescriptor[] datanodes = (DatanodeDescriptor[]) namesystem.heartbeats
                    .toArray(new DatanodeDescriptor[REPLICATION_FACTOR]);
