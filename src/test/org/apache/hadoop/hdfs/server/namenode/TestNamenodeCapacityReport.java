    ...
    public void testVolumeSize() throws Exception {
        ...
        try {
            ...
            for (final DatanodeDescriptor datanode : live) {
                ...
                LOG.info("Datanode configCapacity " + configCapacity + " used " + used + " non DFS used " + nonDFSUsed
                        + " remaining " + remaining + " perentUsed " + percentUsed + " percentRemaining "
                        + percentRemaining);
            ...
            // Hence the capacity reported by the data node is twice the disk
            // space
            // the disk capacity
            //
            ...
            LOG.info("Name node diskCapacity " + diskCapacity + " configCapacity " + configCapacity + " reserved "
                    + reserved + " used " + used + " remaining " + remaining + " nonDFSUsed " + nonDFSUsed
                    + " remaining " + remaining + " percentUsed " + percentUsed + " percentRemaining "
                    + percentRemaining);
            ...
            // Ensure percent used is calculated based on used and present
            // capacity
