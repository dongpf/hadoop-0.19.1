...
public class TestFileCreationEmpty extends junit.framework.TestCase {
    ...
    /**
     * This test creates three empty files and lets their leases expire. This
     * triggers release of the leases. The empty files are supposed to be closed
     * by that without causing ConcurrentModificationException.
     */
