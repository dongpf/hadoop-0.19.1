...
public class TestGetBlocks extends TestCase {
    ...
    public void testGetBlocks() throws Exception {
        ...
        try {
            ...
            NamenodeProtocol namenode = (NamenodeProtocol) RPC.getProxy(NamenodeProtocol.class,
                    NamenodeProtocol.versionID, addr, UnixUserGroupInformation.login(CONF), CONF,
