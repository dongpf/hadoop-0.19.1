...
public class TestCLI extends TestCase {
    private static final Log LOG = LogFactory.getLog(TestCLI.class.getName());
    ...
    private void displayResults() {
        ...
        assertTrue("One of the tests failed. " + "See the Detailed results to identify " + "the command that failed",
                overallResults);
    ...
    public void testAll() {
        ...
        for (int index = 0; index < testsFromConfigFile.size(); index++) {
            ...
            for (int i = 0; i < testCommands.size(); i++) {
                CommandExecutor.executeFSCommand(testCommands.get(i), namenode);
            }
            ...
            for (int i = 0; i < compdata.size(); i++) {
                ...
                compdata.get(i).setActualOutput(CommandExecutor.getLastCommandOutput());
            ...
            for (int i = 0; i < cleanupCommands.size(); i++) {
                CommandExecutor.executeFSCommand(cleanupCommands.get(i), namenode);
            }
        }
    }
