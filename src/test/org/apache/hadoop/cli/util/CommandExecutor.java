...
public class CommandExecutor {
    ...
    private static String[] getFSCommandAsArgs(final String cmd, final String namenode) {
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            args[i] = args[i].replaceAll("CLITEST_DATA", new File(TestCLI.TEST_CACHE_DATA_DIR).toURI().toString()
                    .replace(' ', '+'));
