...
public class TestIPC extends TestCase {
    ...
    private static class TestServer extends Server {
        ...
        public Writable call(Writable param, long receivedTime) throws IOException {
            if (sleep) {
                try {
                    Thread.sleep(RANDOM.nextInt(2 * PING_INTERVAL)); // sleep a
                                                                     // bit
    ...
    public void testSerial(int handlerCount, boolean handlerSleep, int clientCount, int callerCount, int callCount)
            throws Exception {
    ...
    public void testParallel(int handlerCount, boolean handlerSleep, int serverCount, int addressCount,
