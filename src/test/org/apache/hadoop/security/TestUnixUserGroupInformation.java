...
public class TestUnixUserGroupInformation extends TestCase {
    ...
    public void testLogin() throws Exception {
        ...
        UnixUserGroupInformation curUserGroupInfo = UnixUserGroupInformation.login(conf);
    ...
    public void testConstructor() throws Exception {
        ...
        assertEquals(uugi, new UnixUserGroupInformation(
                new String[] { USER_NAME, GROUP1_NAME, GROUP2_NAME, GROUP3_NAME }));
        // failure test
    ...
    public void testEquals() throws Exception {
        ...
        assertFalse(uugi.equals(new UnixUserGroupInformation(USER_NAME, new String[] { GROUP2_NAME, GROUP3_NAME,
                GROUP1_NAME })));
    }
