...
public class TestJobControl extends junit.framework.TestCase {
     ...
     * indir to outdir_1 Job 2: copy data from indir to outdir_2 Job 3: copy
     * data from outdir_1 and outdir_2 to outdir_3 Job 4: copy data from outdir
     * to outdir_4 The jobs 1 and 2 have no dependency. The job 3 depends on
     * jobs 1 and 2. The job 4 depends on job 3.
     * 
    ...
    public static void doJobControlTest() throws Exception {
        ...
        if (job_1.getState() != Job.FAILED && job_1.getState() != Job.DEPENDENT_FAILED
        ...
        if (job_2.getState() != Job.FAILED && job_2.getState() != Job.DEPENDENT_FAILED
        ...
        if (job_4.getState() != Job.FAILED && job_4.getState() != Job.DEPENDENT_FAILED
        ...
        if (job_1.getState() == Job.FAILED || job_2.getState() == Job.FAILED
                || job_1.getState() == Job.DEPENDENT_FAILED || job_2.getState() == Job.DEPENDENT_FAILED) {
