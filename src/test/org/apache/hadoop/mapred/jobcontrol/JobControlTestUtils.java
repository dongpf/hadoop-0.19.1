...
public class JobControlTestUtils {
     ...
     *            Path to be deleted.
     * @throws IOException
     *             If an error occurs cleaning the data.
     */
     ...
     * @param dirPath
     *            Path to create the data in.
     * @throws IOException
     *             If an error occurs creating the data.
     */
     ...
     * @throws Exception
     *             If an error occurs creating job configuration.
     */
     ...
     */
    public static class DataCopy extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>,
