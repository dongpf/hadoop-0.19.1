...
public class TestLocalJobControl extends HadoopTestCase {
    ...
    public static final Log LOG = LogFactory.getLog(TestLocalJobControl.class.getName());

    /**
     * Initialises a new instance of this test case to use a Local MR cluster
     * and a local filesystem.
     * 
     * @throws IOException
     *             If an error occurs initialising this object.
     */
