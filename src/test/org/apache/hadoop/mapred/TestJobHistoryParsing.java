...
public class TestJobHistoryParsing extends TestCase {
    ...
    static class TestListener implements Listener {
        ...
        public void handle(RecordTypes recType, Map<JobHistory.Keys, String> values) throws IOException {
    ...
    public void testHistoryParsing() throws IOException {
        ...
        String value3 = "Value has characters: " + "`1234567890-=qwertyuiop[]\\asdfghjkl;'zxcvbnm,./"
                + "~!@#$%^&*()_+QWERTYUIOP{}|ASDFGHJKL:\"'ZXCVBNM<>?" + "\t\b\n\f\"\n in it";
        ...
        JobHistory.log(historyWriter, RecordTypes.Job, new JobHistory.Keys[] { Keys.JOBTRACKERID, Keys.TRACKER_NAME,
                Keys.JOBNAME, Keys.JOBCONF, Keys.USER }, new String[] { value1, value2, value3, value4, value5 });
        // close history file
        out.close();
