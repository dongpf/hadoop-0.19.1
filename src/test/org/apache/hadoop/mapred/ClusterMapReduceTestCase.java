 ...
 * <p/>
 * It creates a temporary directory -accessible via getTestRootDir()- for both
 * input and output.
 * <p/>
 * The input directory is accesible via getInputDir() and the output directory
 * via getOutputDir()
 * <p/>
...
public abstract class ClusterMapReduceTestCase extends TestCase {
     ...
     * <p/>
     * Note that the cluster is already started when the testcase method is
     * invoked. This method is useful if as part of the testcase the cluster has
     * to be shutdown and restarted again.
     * <p/>
     * If the cluster is already running this method does nothing.
     * 
     * @param reformatDFS
     *            indicates if DFS has to be reformated
     * @param props
     *            configuration properties to inject to the mini cluster
     * @throws Exception
     *             if the cluster could not be started
     */
    ...
    private static class ConfigurableMiniMRCluster extends MiniMRCluster {
        ...
        public ConfigurableMiniMRCluster(int numTaskTrackers, String namenode, int numDir) throws Exception {
     ...
     * 
     * @throws Exception
     *             if the cluster could not be stopped
     */
