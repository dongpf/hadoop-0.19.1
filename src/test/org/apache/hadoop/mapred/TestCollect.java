...
public class TestCollect extends TestCase {
    ...
    static class Map implements Mapper<Text, Text, IntWritable, IntWritable> {
        ...
        public void map(Text key, Text val, final OutputCollector<IntWritable, IntWritable> out, Reporter reporter)
                throws IOException {
    ...
    static class Reduce implements Reducer<IntWritable, IntWritable, IntWritable, IntWritable> {
        ...
        public void reduce(IntWritable key, Iterator<IntWritable> val, OutputCollector<IntWritable, IntWritable> out,
    ...
    public void configure(JobConf conf) throws IOException {
        ...
        conf.setInputFormat(RandomInputFormat.class); // for self data
                                                      // generation
