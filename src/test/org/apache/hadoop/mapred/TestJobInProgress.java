...
public class TestJobInProgress extends TestCase {
    ...
    // We don't need to bother about the actual key value pairs which are
    // passed.
    ...
    protected void setUp() throws Exception {
        ...
        mrCluster = new MiniMRCluster(taskTrackers, dfsCluster.getFileSystem().getUri().toString(), 1);
    ...
    void checkTaskCounts() {
        ...
        for (JobStatus js : status) {
            ...
            long totalTaskCount = counter.getCounter(JobInProgress.Counter.TOTAL_LAUNCHED_MAPS)
