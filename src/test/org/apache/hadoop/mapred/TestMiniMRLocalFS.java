...
public class TestMiniMRLocalFS extends TestCase {
    ...
    public void testWithLocal() throws IOException {
        ...
        try {
            ...
            TestResult ret = MRCaching.launchMRCache(TEST_ROOT_DIR + "/wc/input", TEST_ROOT_DIR + "/wc/output",
                    TEST_ROOT_DIR + "/cachedir", job, "The quick brown fox\n" + "has many silly\n" + "red fox sox\n");
    ...
    private static class MyInputFormat implements InputFormat<IntWritable, Text> {
        ...
        static final String[] data = new String[] { "crocodile pants", "aunt annie", "eggs", "finagle the agent",
                "bumble boat", "duck-dog", };
