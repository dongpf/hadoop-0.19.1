...
public class TestCounters extends TestCase {
    ...
    private void testCounter(Counters counter) throws ParseException {
        ...
        assertTrue("Recovered counter does not match on content", counter.contentEquals(recoveredCounter));

    }

    public void testCounters() throws IOException {
        Enum[] keysWithResource = { Task.FileSystemCounter.HDFS_READ, Task.Counter.MAP_INPUT_BYTES,
