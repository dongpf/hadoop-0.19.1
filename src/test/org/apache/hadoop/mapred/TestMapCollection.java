...
public class TestMapCollection extends TestCase {
    ...
    public static class SpillMapper implements Mapper<NullWritable, NullWritable, KeyWritable, ValWritable> {
        ...
        public void map(NullWritable key, NullWritable value, OutputCollector<KeyWritable, ValWritable> out,
    ...
    public static class SpillReducer implements Reducer<KeyWritable, ValWritable, NullWritable, NullWritable> {
        ...
        public void reduce(KeyWritable k, Iterator<ValWritable> values,
            ...
            assertEquals("Unexpected record count (" + i + "/" + numrecs + ")", numrecs, i);
        }
    ...
    public static class FakeIF implements InputFormat<NullWritable, NullWritable> {
        ...
        public RecordReader<NullWritable, NullWritable> getRecordReader(InputSplit ignored, JobConf conf,
                Reporter reporter) {
    ...
    private static void runTest(String name, int keylen, int vallen, int records, int ioSortMB, float recPer,
            float spillPer, boolean pedantic) throws Exception {
