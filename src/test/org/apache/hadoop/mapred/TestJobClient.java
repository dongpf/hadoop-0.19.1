...
public class TestJobClient extends ClusterMapReduceTestCase {
    ...
    public void testGetCounter() throws Exception {
        ...
        int exitCode = runTool(createJobConf(), new JobClient(), new String[] { "-counter", jobId,
                "org.apache.hadoop.mapred.Task$Counter", "MAP_INPUT_RECORDS" }, out);
    ...
    public void testChangingJobPriority() throws Exception {
        String jobId = runJob();
        int exitCode = runTool(createJobConf(), new JobClient(), new String[] { "-set-priority", jobId, "VERY_LOW" },
