...
public class TestMiniMRMapRedDebugScript extends TestCase {
     ...
     * 
     * @param filter
     *            Task log filer; can be STDOUT, STDERR, SYSLOG, DEBUGOUT,
     *            DEBUGERR
     * @param taskId
     ...
     * @throws IOException
     */
    public static String readTaskLog(TaskLog.LogName filter, TaskAttemptID taskId) throws IOException {
     ...
     * 
     * @param conf
     *            configuration for the mapred job
     * @param inDir
     *            input path
     * @param outDir
     *            output path
     ...
     * 
     * In this test, we launch a mapreduce program which writes 'Bailing out' to
     * stderr and throws an exception. We will run the script when tsk fails and
     * validate the output of debug out log.
     * 
     */
