...
/**
 * A JUnit test to test that killing completed jobs does not move them to the
 * failed sate - See JIRA HADOOP-2132
 */
public class TestKillCompletedJob extends TestCase {

    static Boolean launchWordCount(String fileSys, String jobTracker, JobConf conf, String input, int numMaps,
    ...
    public void testKillCompJob() throws IOException {
        ...
        try {
            ...
            result = launchWordCount(namenode, jobTrackerName, jobConf, "Small text\n", 1, 0);
            assertTrue(result);
