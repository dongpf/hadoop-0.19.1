...
/**
 * A JUnit test to test Mini Map-Reduce Cluster with multiple directories and
 * check for correct classpath
 */
public class TestMiniMRClasspath extends TestCase {

    static String launchWordCount(String fileSys, String jobTracker, JobConf conf, String input, int numMaps,
    ...
    static String launchExternal(String fileSys, String jobTracker, JobConf conf, String input, int numMaps,
            int numReduces) throws IOException {
    ...
    public void testClassPath() throws IOException {
        ...
        try {
            ...
            result = launchWordCount(namenode, jobTrackerName, jobConf, "The quick brown fox\nhas many silly\n"
                    + "red fox sox\n", 3, 1);
            assertEquals("The\t1\nbrown\t1\nfox\t2\nhas\t1\nmany\t1\n" + "quick\t1\nred\t1\nsilly\t1\nsox\t1\n", result);
    ...
    public void testExternalWritable() throws IOException {
        ...
        try {
            ...
            result = launchExternal(namenode, jobTrackerName, jobConf, "Dennis was here!\nDennis again!", 3, 1);
