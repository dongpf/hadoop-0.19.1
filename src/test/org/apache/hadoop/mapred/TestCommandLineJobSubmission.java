...
/**
 * check for the job submission options of -libjars -files -archives
 */
...
public class TestCommandLineJobSubmission extends TestCase {
    ...
    public void testJobShell() throws Exception {
        ...
        try {
            ...
            // before running the job, verify that libjar is not in client
            // classpath
            ...
            // after running the job, verify that libjar is in the client
            // classpath
