...
public class MRCaching {
    ...
    public static TestResult launchMRCache(String indir, String outdir, String cacheDir, JobConf conf, String input)
            throws IOException {
        ...
        int count = 0;
        // after the job ran check to see if the the input from the localized
        // cache
