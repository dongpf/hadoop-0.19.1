...
/**
 * TestMapOutputType checks whether the Map task handles type mismatch between
 * mapper output and the type specified in JobConf.MapOutputKeyType and
 * JobConf.MapOutputValueType.
 */
public class TestMapOutputType extends TestCase {
    ...
    /**
     * TextGen is a Mapper that generates a Text key-value pair. The type
     * specified in conf will be anything but.
     */
    ...
    static class TextGen implements Mapper<WritableComparable, Writable, Text, Text> {
        ...
        public void map(WritableComparable key, Writable val, OutputCollector<Text, Text> out, Reporter reporter)
                throws IOException {
