...
public class TestRecordVersioning extends TestCase {
    ...
    /*
     * basic versioning write out a record and its type info, read it back using
     * its typeinfo
     */
    ...
    /*
     * versioning write out a record and its type info, read back a similar
     * record using the written record's typeinfo
     */
