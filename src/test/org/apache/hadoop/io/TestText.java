...
public class TestText extends TestCase {
    ...
    private static String getTestString(int len) throws Exception {
        ...
        while (buffer.length() < length) {
            ...
            if (Character.isDefined(codePoint)) {
                // unpaired surrogate
                if (codePoint < Character.MIN_SUPPLEMENTARY_CODE_POINT && !Character.isHighSurrogate((char) codePoint)
    ...
    public void testCompare() throws Exception {
        ...
        for (int i = 0; i < NUM_ITERATIONS; i++) {
            ...
            assertEquals(comparator.compare(out1.getData(), 0, out3.getLength(), out3.getData(), 0, out3.getLength()),
                    0);
        }
    }
