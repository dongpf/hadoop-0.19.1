...
public class TestGenericWritable extends TestCase {
    ...
    public static class Bar implements Writable, Configurable {
        private int bar = 42; // The Answer to The Ultimate Question Of Life,
    ...
    public static class Baz extends Bar {
        ...
        public void readFields(DataInput in) throws IOException {
            ...
            assertEquals("Configuration is not set for the wrapped object", CONF_TEST_VALUE,
                    getConf().get(CONF_TEST_KEY));
        }
