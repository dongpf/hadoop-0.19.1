...
public class TestVersionedWritable extends TestCase {
    ...
    public static class AdvancedVersionedWritable extends SimpleVersionedWritable {
        ...
        String compressableTestString = "Blah. Blah. Blah. Blah. Blah. Blah. Blah. Blah. Blah. Blah. Blah. Blah. "
        ...
        public void write(DataOutput out) throws IOException {
            ...
            containedObject.write(out); // Warning if this is a recursive call,
                                        // you need a null value.
        ...
        public void readFields(DataInput in) throws IOException {
            ...
            containedObject.readFields(in); // Warning if this is a recursive
                                            // call, you need a null value.
    ...
    /**
     * Test 2: Check that AdvancedVersionedWritable Works (well, why wouldn't
     * it!).
     */
