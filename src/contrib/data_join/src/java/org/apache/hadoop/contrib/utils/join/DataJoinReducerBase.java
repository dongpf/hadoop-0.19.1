...
public abstract class DataJoinReducerBase extends JobBase {
     ...
     * @throws IOException
     */
    private void joinAndCollect(Object[] tags, ResetableIterator[] values, Object key, OutputCollector output,
     ...
     * @throws IOException
     */
    private void joinAndCollect(Object[] tags, ResetableIterator[] values, int pos, Object[] partialList, Object key,
