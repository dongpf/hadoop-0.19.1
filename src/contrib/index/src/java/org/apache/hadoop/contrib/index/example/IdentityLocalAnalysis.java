 ...
 */
public class IdentityLocalAnalysis implements ILocalAnalysis<DocumentID, DocumentAndOp> {
     ...
     */
    public void map(DocumentID key, DocumentAndOp value, OutputCollector<DocumentID, DocumentAndOp> output,
