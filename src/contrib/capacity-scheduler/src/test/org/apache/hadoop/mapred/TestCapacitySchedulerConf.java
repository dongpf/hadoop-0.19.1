...
public class TestCapacitySchedulerConf extends TestCase {
    ...
    public TestCapacitySchedulerConf() {
        defaultProperties = setupQueueProperties(new String[] { "guaranteed-capacity", "reclaim-time-limit",
                "supports-priority", "minimum-user-limit-percent" }, new String[] { "100", "300", "false", "100" });
    }
    ...
    public void testDefaults() {
        ...
        Map<String, Map<String, String>> queueDetails = new HashMap<String, Map<String, String>>();
    ...
    public void testQueues() {
        ...
        Map<String, String> q1Props = setupQueueProperties(new String[] { "guaranteed-capacity", "reclaim-time-limit",
                "supports-priority", "minimum-user-limit-percent" }, new String[] { "10", "600", "true", "25" });

        Map<String, String> q2Props = setupQueueProperties(new String[] { "guaranteed-capacity", "reclaim-time-limit",
                "supports-priority", "minimum-user-limit-percent" }, new String[] { "100", "6000", "false", "50" });
    ...
    public void testQueueWithDefaultProperties() {
        Map<String, String> q1Props = setupQueueProperties(new String[] { "guaranteed-capacity",
                "minimum-user-limit-percent" }, new String[] { "20", "75" });
        startConfig();
        writeQueueDetails("default", q1Props);
        endConfig();
    ...
    public void testReload() throws IOException {
        ...
        Map<String, String> q1Props = setupQueueProperties(new String[] { "guaranteed-capacity", "reclaim-time-limit",
                "supports-priority", "minimum-user-limit-percent" }, new String[] { "20.5", "600", "true", "40" });

        Map<String, String> q2Props = setupQueueProperties(new String[] { "guaranteed-capacity", "reclaim-time-limit",
                "supports-priority", "minimum-user-limit-percent" }, new String[] { "100", "3000", "false", "50" });
    ...
    private void checkQueueProperties(CapacitySchedulerConf testConf, Map<String, Map<String, String>> queueDetails) {
        for (String queueName : queueDetails.keySet()) {
            Map<String, String> map = queueDetails.get(queueName);
            assertEquals(Float.parseFloat(map.get("guaranteed-capacity")), testConf.getGuaranteedCapacity(queueName));
            assertEquals(Integer.parseInt(map.get("minimum-user-limit-percent")),
                    testConf.getMinimumUserLimitPercent(queueName));
            assertEquals(Integer.parseInt(map.get("reclaim-time-limit")), testConf.getReclaimTimeLimit(queueName));
            assertEquals(Boolean.parseBoolean(map.get("supports-priority")), testConf.isPrioritySupported(queueName));
        }
    }

    private Map<String, String> setupQueueProperties(String[] keys, String[] values) {
    ...
    private void writeQueueDetails(String queue, Map<String, String> props) {
        for (String key : props.keySet()) {
            ...
            writer.println("<name>mapred.capacity-scheduler.queue." + queue + "." + key + "</name>");
