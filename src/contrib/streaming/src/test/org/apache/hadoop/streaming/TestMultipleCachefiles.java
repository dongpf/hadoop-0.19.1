...
/**
 * This test case tests the symlink creation utility provided by distributed
 * caching
 */
    ...
    public void testMultipleCachefiles() {
        try {
            ...
            try {
                ...
                // During tests, the default Configuration will use a local
                // mapred
                ...
                String argv[] = new String[] {
                        ...
                        "-jobconf",
                        "mapred.child.java.opts=-Dcontrib.name=" + System.getProperty("contrib.name") + " "
                                + "-Dbuild.test=" + System.getProperty("build.test") + " "
                                + conf.get("mapred.child.java.opts", ""), "-cacheFile",
                        "hdfs://" + fileSys.getName() + CACHE_FILE + "#" + mapString, "-cacheFile",
                        "hdfs://" + fileSys.getName() + CACHE_FILE_2 + "#" + mapString2 };
