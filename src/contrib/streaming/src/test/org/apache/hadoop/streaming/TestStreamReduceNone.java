...
/**
 * This class tests hadoopStreaming in MapReduce local mode. It tests the case
 * where number of reducers is set to 0. In this case, the mappers are expected
 * to write out outputs directly. No reducer/combiner will be activated.
 */
public class TestStreamReduceNone extends TestCase {
    ...
    protected String[] genArgs() {
        return new String[] { "-input", INPUT_FILE.getAbsolutePath(), "-output", OUTPUT_DIR.getAbsolutePath(),
                "-mapper", map, "-reducer", "org.apache.hadoop.mapred.lib.IdentityReducer", "-numReduceTasks", "0",
