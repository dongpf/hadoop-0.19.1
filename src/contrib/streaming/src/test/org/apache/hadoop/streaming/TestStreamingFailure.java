...
/**
 * This class tests if hadoopStreaming returns Exception on failure when
 * submitted an invalid/failed job The test case provides an invalid input file
 * for map/reduce job as a unit test case
 */
public class TestStreamingFailure extends TestStreaming {
    ...
    protected String[] genArgs() {
        return new String[] { "-input", INVALID_INPUT_FILE.getAbsolutePath(), "-output", OUTPUT_DIR.getAbsolutePath(),
                "-mapper", map, "-reducer",
                reduce,
                // "-verbose",
