...
/**
 * This class tests hadoopStreaming in MapReduce local mode. This testcase looks
 * at different cases of tab position in input.
 */
public class TestStreamingKeyValue extends TestCase {
    ...
    protected String outputExpect = "\tviolets are blue\nbunnies are pink\t\n" + "roses are \tred\t\n"
            + "small input\t\n" + "this is for testing a big\tinput line\n";
    ...
    protected String[] genArgs() {
        return new String[] { "-input", INPUT_FILE.getAbsolutePath(), "-output", OUTPUT_DIR.getAbsolutePath(),
                "-mapper", "cat", "-jobconf", "keep.failed.task.files=true", "-jobconf",
                "stream.non.zero.exit.is.failure=true", "-jobconf",
