...
public class StreamUtil {
    ...
    /**
     * It may seem strange to silently switch behaviour when a String is not a
     * classname; the reason is simplified Usage:
     * 
     * <pre>
    ...
    public static String findInClasspath(String className, ClassLoader loader) {
        ...
        if (classUrl != null) {
            ...
            if (inJar) {
                ...
                if (pos == -1) {
                    throw new IllegalArgumentException("invalid codePath: className=" + className + " codePath="
                            + codePath);
                }
     ...
     *            If foo is undefined then Ant sets the unevaluated value. Take
     *            this into account when setting defaultVal.
     */
