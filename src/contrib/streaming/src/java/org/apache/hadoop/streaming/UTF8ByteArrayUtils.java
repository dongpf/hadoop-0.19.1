...
public class UTF8ByteArrayUtils {
     ...
     * @deprecated use
     *             {@link org.apache.hadoop.util.UTF8ByteArrayUtils#findByte(byte[], int, int, byte)}
     */
    @Deprecated
     ...
     * @return position that first byte occures otherwise -1
     * @deprecated use
     *             {@link org.apache.hadoop.util.UTF8ByteArrayUtils#findBytes(byte[], int, int, byte[])}
     */
    @Deprecated
     ...
     *         otherwise -1
     * @deprecated use
     *             {@link org.apache.hadoop.util.UTF8ByteArrayUtils#findNthByte(byte[], int, int, byte, int)}
     */
    @Deprecated
    public static int findNthByte(byte[] utf, int start, int length, byte b, int n) {
        return org.apache.hadoop.util.UTF8ByteArrayUtils.findNthByte(utf, start, length, b, n);
    }
     ...
     *         otherwise -1
     * @deprecated use
     *             {@link org.apache.hadoop.util.UTF8ByteArrayUtils#findNthByte(byte[], byte, int)}
     */
    @Deprecated
     ...
     * @deprecated use
     *             {@link StreamKeyValUtil#splitKeyVal(byte[], int, int, Text, Text, int, int)}
     * @throws IOException
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static void splitKeyVal(byte[] utf, Text key, Text val, int splitPos, int separatorLength)
            throws IOException {
