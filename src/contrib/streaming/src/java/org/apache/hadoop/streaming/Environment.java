...
/**
 * This is a class used to get the current environment on the host machines
 * running the map/reduce. This class assumes that setting the environment in
 * streaming is allowed on windows/ix/linuz/freebsd/sunos/solaris/hp-ux
 */
public class Environment extends Properties {
    ...
    public Environment() throws IOException {
        ...
        if (OS.indexOf("Windows") > -1) {
            command = "cmd /C set";
        } else if (lowerOs.indexOf("ix") > -1 || lowerOs.indexOf("linux") > -1 || lowerOs.indexOf("freebsd") > -1
                || lowerOs.indexOf("sunos") > -1 || lowerOs.indexOf("solaris") > -1 || lowerOs.indexOf("hp-ux") > -1) {
            command = "env";
