...
/**
 * This class is the main class for generating job.jar for Hadoop Streaming
 * jobs. It includes the files specified with the -file option and includes them
 * in the jar. Also, hadoop-streaming is a user level appplication, so all the
 * classes with hadoop-streaming that are needed in the job are also included in
 * the job.jar.
 */
public class JarBuilder {
    ...
    public static void main(String args[]) {
        // args = new String[] { "C:/Temp/merged.jar",
        // "C:/jdk1.5.0/jre/lib/ext/dnsns.jar", "/Temp/addtojar2.log",
        // "C:/jdk1.5.0/jre/lib/ext/mtest.jar", "C:/Temp/base"};
        if (args.length < 2) {
