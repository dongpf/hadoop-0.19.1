...
/**********************************************************
 * Runs a set of monitoring jobs once for the local node. The set of jobs to be
 * run is the intersection of the jobs specifed in the configuration file and
 * the set of jobs specified in the --only command line argument.
 **********************************************************/
