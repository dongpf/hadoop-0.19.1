...
/**********************************************************
 * Objects of this class hold the serialized representations of EventRecords. A
 * SerializedRecord is essentially an EventRecord with all its property values
 * converted to strings. It also provides some convenience methods for printing
 * the property fields in a more readable way.
 * 
 **********************************************************/
...
public class SerializedRecord {
    ...
    private static DateFormat dateFormatter = DateFormat.getDateTimeInstance(DateFormat.LONG, DateFormat.LONG);;
    ...
    /**
     * Arrange the keys to provide a more readable printing order: first goes
     * the timestamp, then the hostname and then the type, followed by all other
     * keys found.
     * 
     * @param keys
     *            The input ArrayList of keys to re-arrange.
     */
    ...
    /**
     * Check if the SerializedRecord is a valid one, i.e., whether it represents
