...
/**********************************************************
 * This class executes monitoring jobs on all nodes of the cluster, on which we
 * intend to gather failure metrics. It is basically a thread that sleeps and
 * periodically wakes up to execute monitoring jobs and ship all gathered data
 * to a "safe" location, which in most cases will be the HDFS filesystem of the
 * monitored cluster.
 * 
 **********************************************************/
...
public class Executor implements Runnable {
     ...
     * determine the set of jobs that will be run and the maximum interval for
     * which the thread can sleep before it wakes up to execute a monitoring job
     * on the node.
     * 
     */
