...
/**********************************************************
 * This class takes care of the temporary local storage of gathered metrics
 * before they get uploaded into HDFS. It writes Serialized Records as lines in
 * a temporary file and then compresses and uploads it into HDFS.
 * 
 **********************************************************/
...
public class LocalStore {
    ...
    /**
     * Create an instance of the class and read the configuration file to
     * determine some output parameters. Then, initiate the structured needed
     * for the buffered I/O (so that smal appends can be handled efficiently).
     * 
     */
    ...
    public LocalStore() {
        ...
        filename = Environment.getProperty("local.tmp.dir") + "/" + Environment.getProperty("local.tmp.filename");
    ...
    /**
     * Insert an EventRecord to the local storage, after it gets serialized and
     * anonymized.
     * 
     * @param er
     *            the EventRecord to be inserted
     */
    ...
    /**
     * Insert an array of EventRecords to the local storage, after they get
     * serialized and anonymized.
     * 
     * @param ers
     ...
     * 
     * @param sr
     *            the SerializedRecord to be packed
     */
    ...
    /**
     * Upload the local file store into HDFS, after it compressing it. Then a
     * new local file is created as a temporary record store.
     * 
     */
    public void upload() {
        try {
