...
/**********************************************************
 * This class provides anonymization to SerializedRecord objects. It anonymizes
 * all hostnames, ip addresses and file names/paths that appear in EventRecords
 * gathered from the logs and other system utilities. Such values are hashed
 * using a cryptographically safe one-way-hash algorithm (MD5).
 * 
 **********************************************************/
...
public class Anonymizer {
    ...
    /**
     * Anonymize hostnames, ip addresses and file names/paths that appear in
     * fields of a SerializedRecord.
     * 
     * @param sr
    ...
    /**
     * Anonymize hostnames, ip addresses and file names/paths that appear in
     * fields of an EventRecord, after it gets serialized into a
     * SerializedRecord.
     * 
     * @param er
