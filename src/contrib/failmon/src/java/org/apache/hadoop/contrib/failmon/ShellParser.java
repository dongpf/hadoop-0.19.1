...
/**********************************************************
 * Objects of this class parse the output of system command-line utilities that
 * can give information about the state of various hardware components in the
 * system. Typically, each such object either invokes a command and reads its
 * output or reads the output of one such command from a file on the disk.
 * Currently supported utilities include ifconfig, smartmontools, lm-sensors,
 * /proc/cpuinfo.
 * 
 **********************************************************/
...
public abstract class ShellParser implements Monitored {
    ...
    /**
     * Find the first occurence ofa pattern in a piece of text and return a
     * specific group.
     * 
     * @param strPattern
    ...
    /**
     * Finds all occurences of a pattern in a piece of text and returns the
     * matching groups.
     * 
     * @param strPattern
     *            the regular expression to match
