 ...
 * Typically, such objects read log files line by line and for each log entry
 * they identify, they create a corresponding EventRecord. In this way,
 * disparate log files can be merged using the uniform format of EventRecords
 * and can, thus, be processed in a uniform way.
 * 
 **********************************************************/
...
public abstract class LogParser implements Monitored {
     ...
     * 
     * @param fname
     *            the filename of the log file to be read
     */
    ...
    /**
     * Insert all EventRecords that can be extracted for the represented
    ...
    /**
     * Continue parsing the log file until a valid log entry is identified. When
     * one such entry is found, parse it and return a corresponding EventRecord.
     * 
     * 
    ...
    /**
     * Check whether the log file has been rotated. If so, start reading the
