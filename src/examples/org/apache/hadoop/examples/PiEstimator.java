...
public class PiEstimator extends Configured implements Tool {
    ...
    public static class PiMapper extends MapReduceBase implements
            Mapper<LongWritable, Writable, LongWritable, LongWritable> {
         ...
         * @param reporter
         */
        public void map(LongWritable key, Writable val, OutputCollector<LongWritable, LongWritable> out,
    ...
    public static class PiReducer extends MapReduceBase implements
            Reducer<LongWritable, LongWritable, WritableComparable, Writable> {
    ...
    double launch(int numMaps, long numPoints, String jt, String dfs) throws IOException {
        ...
        for (int idx = 0; idx < numMaps; ++idx) {
            ...
            SequenceFile.Writer writer = SequenceFile.createWriter(fileSys, jobConf, file, LongWritable.class,
                    LongWritable.class, CompressionType.NONE);
    ...
    public int run(String[] args) throws Exception {
        ...
        System.out.println("Estimated value of PI is " + launch(nMaps, nSamples, null, null));
