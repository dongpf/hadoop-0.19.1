 ...
 * 
 * To run: bin/hadoop jar build/hadoop-examples.jar join [-m <i>maps</i>] [-r
...
public class Join extends Configured implements Tool {
    ...
    static int printUsage() {
        System.out.println("join [-m <maps>] [-r <reduces>] " + "[-inFormat <input format class>] "
                + "[-outFormat <output format class>] " + "[-outKey <output key class>] "
                + "[-outValue <output value class>] " + "[-joinOp <inner|outer|override>] "
                + "[input]* <input> <output>");
